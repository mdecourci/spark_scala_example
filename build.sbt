...
libraryDependencies += "org.apache.spark" %% "spark-core" % "2.2.0" excludeAll(ExclusionRule(organization = "com.sun.jersey"), ExclusionRule(organization = "com.fasterxml.jackson.core"))
//excludeAll(ExclusionRule(organization = "javax.servlet"), ExclusionRule(organization = "com.sun.jersey"))
